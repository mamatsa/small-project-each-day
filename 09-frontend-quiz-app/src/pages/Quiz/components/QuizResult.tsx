...
const QuizResult = ({ subject, onQuizRestart, score }: QuizResultProps) => {
  ...
  return (
    <div className="grid-cols-2 lg:grid">
      <h1 className="mb-6 text-4xl font-light leading-tight dark:text-white sm:mb-8 sm:text-5xl lg:text-6xl">
        Quiz completed
      ...
      <div>
        <div className="flex w-full flex-col items-center justify-center rounded-xl bg-white p-8 dark:bg-navy">
          ...
          <p className="my-7 text-7xl font-medium dark:text-white sm:text-8xl lg:my-8">
            {score}
          </p>
